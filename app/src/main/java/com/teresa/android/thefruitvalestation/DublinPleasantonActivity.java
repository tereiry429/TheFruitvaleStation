package com.teresa.android.thefruitvalestation;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            firstTrainTextView.setText(firstTrainMinutes + " minutes");
                            secondTrainTextView.setText(secondTrainMinutes + " minutes");
                            thirdTrainTextView.setText(thirdTrainMinutes  + " minutes");
